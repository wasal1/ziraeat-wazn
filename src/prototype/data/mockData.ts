...
export const subscriptionPlans: SubscriptionPlan[] = [
  {
    ...
    color: '#16a34a',
    accentClass: 'green',
    limits: { farms: 1, users: 3, fields: 5, greenhouses: 5, activeCycles: 10, aiReports: 0 },
    features: [
    ...
    lockedModules: [
      'المخزون', 'إدارة العمال', 'محطة التحلية', 'مقارنة المزارع', 'لوحات متعددة المزارع',
      'الحساسات والقراءات', 'الكاميرات والمراقبة', 'التحليل الذكي', 'الري الكهربائي والمضخات',
    ],
  },
  {
    id: 'professional',
    ...
    features: [
      ...
      'الري الكهربائي والمضخات (حتى 5 مضخات)',
      'الحساسات والقراءات (حتى 10 حساسات)',
      'كاميرات المراقبة (حتى 4 كاميرات)',
      'محطة التحلية المبسطة',
      'التحليل الذكي — 10 تقارير ذكاء اصطناعي سنوياً',
  ...
  },
  {
    ...
    features: [
      ...
      'حساسات وقراءات غير محدودة',
      'مضخات وري كهربائي غير محدود',
      'كاميرات مراقبة غير محدودة',
      'التحليل الذكي الكامل — 40 تقرير سنوياً',
...
export const moduleAccessMap: Record<PlanId, string[]> = {
  starter: [
    ...
    'الري اليدوي', 'المبيعات', 'المصروفات', 'التقارير الأساسية',
  ],
  professional: [
    'لوحة التحكم', 'المزارع والحقول', 'المزروعات', 'الدورات الزراعية',
    'العمليات الزراعية', 'الحصاد', 'التسميد', 'الأمراض والآفات',
    ...
    'الحساسات والقراءات (محدود)', 'الري الكهربائي والمضخات (محدود)',
    'التحليل الذكي (10 تقارير)', 'التقارير المتقدمة', 'الشتلات',
  ],
  company: [
