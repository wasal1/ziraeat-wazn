...
const TITLES: Record<string, { title: string; sub: string }> = {
  ...
  dailyops:      { title: 'العمليات اليومية',             sub: 'متابعة ومراقبة العمليات الزراعية اليومية' },
  tasks:         { title: 'المهام وأوامر العمل',           sub: 'إدارة ومتابعة أوامر العمل وتوزيع المهام' },
  messages:      { title: 'المراسلات والمرفقات',           sub: 'محادثات الفريق والموردين وتبادل الملفات' },
  cameras:       { title: 'الكاميرات والمراقبة',           sub: 'مراقبة المزارع والبيوت المحمية بشبكة الكاميرات' },
  pumps:         { title: 'الري الكهربائي والمضخات',       sub: 'مراقبة المضخات واستهلاك الطاقة وجدولة الري' },
  sensors:       { title: 'الحساسات والقراءات',            sub: 'رصد قراءات الحساسات البيئية وجودة التربة' },
